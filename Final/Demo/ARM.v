...
module ARM(
    ...
    assign debug_r0 = rf.RF[0];
    assign debug_r1 = rf.RF[1];
    assign debug_r2 = rf.RF[2];
    assign debug_r3 = rf.RF[3];

    assign debug_r4 = rf.RF[4];
    assign debug_r5 = rf.RF[5];
    assign debug_r6 = rf.RF[6];
    assign debug_r7 = rf.RF[7];
